...
case class Pushloc(param: Int) extends Opcode("PUSHLOC", param)
case class Pushglob(param: Int) extends Opcode("PUSHGLOB", param)
case class Slide(param: Int) extends Opcode("SLIDE", param)
